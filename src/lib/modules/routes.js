...
module.exports = {
    ...
    index,usuarios,clientes,vendedores,fornecedores,produtos,funcionarios,prestadores_servicos,estoque_material_producao,estoque_produto_final,formas_pagamentos,contas_pagar,contas_receber,caixa,relatorios,app
